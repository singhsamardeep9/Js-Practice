...
console.log(runs.toString()) /*output--> 400(this is of sting type) after converting the value to string
...
console.log(otherNum.toPrecision(4));//output-->23.90(this value s in the form of string)
...
//-------------------------------------------Maths------------------------------------------------
 ...
 //Math is js is also an object containing various predefined function in key:value pairs
 ...
 //Math.random() by  default gives random value between 0 to 1 at every time it executes
 console.log(Math.random()); //ex-ouput-->0.698245867598343

 //suppose we build a software where we require a random value b/w 1 to 10
 console.log(Math.random()*10) 
 //but using this can also give a value like 0.18364 ince Math.random took 0.018364 as an input b/w[0-1]
