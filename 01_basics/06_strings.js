/*
In JS string can be initialised using both single quotes('') anf double quotes("") and for
...
console.log(name + score + "runs"); //this is an older way
...
console.log(`Hello my name is ${name} and i scored ${score} runs`);//this syntax is modern and better
...
value of the string userName sincce it is of ptimitive type*/
...
hyphen(-) then split method is used*,it is important to note that split can also be dine in the basis
some character/whitespace/symbol*/
...
//trim method--> removes all the extra white spaces in the start and end
const newStr2 = "   Samar    "
